...
public class NewsActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {
    ...
    /** URL for news data using the Guardian API */
...
//       end url: https://content.guardianapis.com/search?page=20&q=debate&tag=politics/politics&from-date=2020-01-01&api-key=test&show-fields=thumbnail&show-tags=contributor
        uriBuilder.appendQueryParameter("page","20");
